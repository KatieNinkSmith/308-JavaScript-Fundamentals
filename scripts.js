...
const learnerSubmissions = [
  ...
  {learner_id: 197, assignment_id: 2, submission: {Submitted_at: "2023-03-07", score: 5000}}
];

let learnerId = learnerSubmissions.map(function (obj) {

  // let scoreNum = newArr.map(function (scNum){
  //   return { 
  //     score: Number(scNum.score), 
  //   }});
      return {
...
// function learnerId(arrOfObjects){
//   for(i=0; i<learnerSumbmissions.length; i++){
//     return learnerSubmissions['learner_id']
//   }  
//   console.log(learnerId);
// }
